...
$sql = "SELECT message,score,lat,lon,attitude FROM Yaks WHERE attitude='positive'";
...
// tweets
$ydata = array();
$sql = "SELECT tweetid,message,favorites,retweets,lat,lon,attitude FROM Tweets WHERE attitude='pos' ORDER BY tweetid desc";
$result = $conn->query($sql);
